<?php
class Admin_Host_Users extends Admin_Controller
{
    protected $section = 'host_users';
    ...
    {
        $extra['title'] = lang('hosts:host_users');

        $extra['buttons'] = array(
            array(
            'label'     => lang('global:edit'),
            'url'       => 'admin/hosts/host_users/edit/-entry_id-'
            ),
            array(
            'label'     => lang('global:delete'),
            'url'       => 'admin/hosts/host_users/delete/-entry_id-',
            'confirm'   => true,
            )
        );

        $this->streams->cp->entries_table('host_users', 'hosts', 3, 'admin/hosts/host_users/index', true, $extra);
    }
