...
<div class="content">
	...
	<thead>
	    ...
	    <tr>
		<td><a href="admin/payignite/plans/view/<?php echo $row->id; ?>"><?php echo $row->name; ?></a>
                </td>
                ...
                <td class="actions">
		<?php echo anchor('admin/payignite/plans/delete/' . $row['id'], lang('global:delete'), array('class' => 'confirm button delete')); ?>
                </td>
	    </tr>
            <?php endforeach; ?>
	</tbody>
