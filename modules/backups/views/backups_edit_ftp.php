...
<div id="body" class="section">
            ...
            <table class="table table-striped datatable">
                <form id="backup-create-form" action="/backups/edit/ftp/{{ backup_id }}" method="post" enctype="multipart/form-data">
                    <div class="table-responsive">
                        <table class='table'>
                            <input type="hidden" name="backup_dest_host_id" id="backup_dest_host_id" value="{{ host_id }}">
                            <input type="hidden" name="backup_dest_type" id="backup_dest_type" value="ftp">
                            <tr class="odd">
                                <td class="col-xs-12">
                            ...
                            <tr class="odd">
                                <td class="col-xs-12">
                                    ...
                                    <select name="backup_dest_passive" id="backup_dest_passive" value="{{ backup_dest_passive }}">
