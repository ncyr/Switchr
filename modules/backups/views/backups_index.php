<div id="body" class="section">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h2>{{ template:title }}
                        <a style="float: right" id="addHost" class="btn btn-default btn create-backup" data-type="awss3" data-host-id="<?php echo $host_id;?>" href="/backups/create/awss3/<?php echo $host_id;?>"><span class="glyphicon glyphicon-plus">Add S3</span></a>
                        <a style="float: right" id="addHost" class="btn btn-default btn create-backup" data-type="ftp" data-host-id="<?php echo $host_id;?>" href="/backups/create/ftp/<?php echo $host_id;?>"><span class="glyphicon glyphicon-plus">Add FTP/SFTP</span></a>
            ...
            <table class="table table-striped datatable">
                <thead>
                    <tr>
                        ...
                        <select>
                            <option disabled>Push All</option>
                        </select>-->
                        </th>
